...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  com.google.android.libraries.places.api.Places.initialize(getApplicationContext(),"AIzaSyDScGnA0jpZ77xdTtf1HZrZdklGUDcG-So");

   //    PlacesClient places= com.google.android.libraries.places.api.Places.createClient(this);
...
//        refreshPlacesData();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PLACE_PICKER_REQUEST && resultCode == RESULT_OK) {
            ...
            LatLng qLocation = place.getLatLng();
            String id = databaseReference.push().getKey();
            Routing hospital = new Routing( String.valueOf(place.getName()),qLocation.latitude,qLocation.longitude,"0");
